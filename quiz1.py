...
class Quiz1:
    ...
    def Quiz1():
        pass
    def load_ply_point_cloud(path: str, self) -> Tuple[np.ndarray, Optional[np.ndarray]]:
        """
    ...
    # Visualization
    # ---------------------------------------------------------------------------
    def visualize(points: np.ndarray, labels: np.ndarray, k: int, self) -> None:
        """
    ...
    def run(self) -> None:
        ...
        data_path = os.path.join(current_path, "airport_downsample.ply")
        parser.add_argument("path", nargs="?", default=data_path)
        ...
        points, point_gt_labels = self.load_ply_point_cloud(args.path)
        ...
        # 6. Visualization
        self.visualize(points, point_gt_labels, args.clusters)
